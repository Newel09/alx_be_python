...
while True:
 weather = str(input("What is the weather today? (sunny/rainy/cold): ").lower()) # .lower() to convert to any case.

 match weather:
    case _ if weather == "sunny":
        print(f"Wear a t-shirt and sunglasses.") # Print this is the weather is sunny.

    case _ if weather == "rainy":
        print(f"Don't forget your umbrella and a raincoat.")

    case _ if weather == "cold":
